...
import { Plane, ArrowLeft, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card border-r border-border flex-col justify-between p-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            We'll send you a password reset link to get you back into your account securely.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          {isSuccess ? (
            <div className="space-y-6">
              <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto lg:mx-0">
